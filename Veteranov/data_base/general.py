import requests
from Veteranov.data_base.google_sheets.google_sheets import GoogleSheets
from Veteranov.data_base.expenses import Expenses
...
class General(GoogleSheets):
    ...
    async def add_credit(self, data, id_col, date_col, creditor_col, type_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSd6SHrd9nb5lHaayYieoaAOt2CX_JMfA1yeNsRNWRJP_hwEzQ"
    ...
    async def add_saving(self, data, id_col, coeff_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSfs_4c-9kBRMVS1sC9FuGLT70oRnVgkWwU08eLRZMkcTP789w"
            urlResponse = form_url+'/formResponse'
            urlReferer = form_url+'/viewform'
