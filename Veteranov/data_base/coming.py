...
class Coming(GoogleSheets):
    ...
    async def add_coming(self, data, names, id_col, date_col, type_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSfIoQln5wsSTaV63bmK8fpqNm1t2x0u0l_vlN_kTvASnhOnaw"
            ...
            print("Coming request is sended", response)
        except:
            return 0
    ...
    async def delete_coming(self, to_delete_id, id_col, delete_col):
        ...
        form_url = "https://docs.google.com/forms/d/e/1FAIpQLScQiiD66ki8n7UGvwn5c8uE23vhylq4OJ8ODW_4haSoep2Ktg"
        urlResponse = form_url+'/formResponse'
        urlReferer = form_url+'/viewform'
