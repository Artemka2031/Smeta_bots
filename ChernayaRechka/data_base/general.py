import requests
from ChernayaRechka.data_base.google_sheets.google_sheets import GoogleSheets
from ChernayaRechka.data_base.expenses import Expenses
...
class General(GoogleSheets):
    ...
    async def add_credit(self, data, id_col, date_col, creditor_col, type_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLScHMqPl2p09_WHbRVbGI2Iyrr0_tywZaaKfyz5WjY93KBaojA"
    ...
    async def add_saving(self, data, id_col, coeff_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSfrBP5WxKYEZzB5josoiogjR2tmYbUqs4D1vaVb9Fo2Hk8m6Q"
            urlResponse = form_url+'/formResponse'
            urlReferer = form_url+'/viewform'
