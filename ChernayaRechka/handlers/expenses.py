...
from ChernayaRechka.create_bot import bot
from ChernayaRechka.keyBoards import expenceKB, generalKB, startKB
...
def register_handlers_admin(dp: Dispatcher):
    ...
    dp.register_message_handler(
        cancel_handler, filters.Regexp(regexp=r"(Отмена расход)"), state='*')
