import requests
from Paroizolaziya.data_base.google_sheets.google_sheets import GoogleSheets
from Paroizolaziya.data_base.expenses import Expenses
...
class General(GoogleSheets):
    ...
    async def add_credit(self, data, id_col, date_col, creditor_col, type_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSfw3oTiZZQl5QwqoU42LRNSSsxkLYk6Fry68GtZ-1desDka6A"
    ...
    async def add_saving(self, data, id_col, coeff_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSddQhTWfeYqIFxEO1pkpacz6GiwjnC5xXvvq3i1BIkjhHl_LQ"
            urlResponse = form_url+'/formResponse'
            urlReferer = form_url+'/viewform'
