...
from Elizarovskaya.data_base.expenses import Expenses
...
class General(GoogleSheets):
    ...
    async def add_credit(self, data, id_col, date_col, creditor_col, type_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSeIcVzvOePQNC_sHdyrU_-vhv86PrsxG7_8zQB0FmTRw5BarQ"
    ...
    async def add_saving(self, data, id_col, coeff_col, ammount_col, comment_col):
        ...
        try:
            ...
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSe889MOGCfz_qpgGGvegYTYWYpSePGW7Us_OuEhMyzt0C7lGw"
            urlResponse = form_url+'/formResponse'
            urlReferer = form_url+'/viewform'
