...
from src.application.dto import CreateRepaymentCommand, CreateRepaymentResult
...
class CreateRepaymentOperation:
    def __init__(self, uow: UnitOfWork) -> None:
        self._uow = uow

    async def execute(self, command: CreateRepaymentCommand) -> CreateRepaymentResult:
        async with self._uow as uow:
            ...
            operation = await uow.operations.add(
                Operation(
                    ...
                    operation_type=OperationType.REPAYMENT,
            ...
            sync_task = await uow.sync_tasks.add(
                SyncTask(
                    ...
                    payload={
                        "operation_type": OperationType.REPAYMENT.value,
                        "operation_id": operation.id,
                    },
